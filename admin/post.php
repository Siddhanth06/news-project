        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td><a href="updatePost.php?id=<?php echo $row['post_id'] ?>" style="text-decoration:none;color:grey"><ion-icon name="create-outline"></ion-icon></a></td>
                    <td><a href="deletePost.php?id=<?php echo $row['post_id'] ?>" style="text-decoration:none;color:grey"><ion-icon name="trash-outline"></ion-icon></a></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
